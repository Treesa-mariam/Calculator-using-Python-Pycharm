...
Button(root,text=" +",command=lambda :get_operation('+')).grid(row=5,column=1)
...
Button(root,text=" =",command=lambda :calculate()).grid(row=3,column=3)
Button(root,text=" pi",command=lambda :get_operation('*3.14')).grid(row=4,column=3)
...
Button(root,text=" x!").grid(row=5,column=4)
Button(root,text=" ^2",command=lambda :get_operation('**2')).grid(row=2,column=5)
Button(root,text=" AC",command=lambda :clear_all()).grid(row=3,column=5)
